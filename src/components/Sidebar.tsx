    ...
    <aside className={styles.sidebar}>
      ...
      <section className={styles.widget}>
        ...
        <div className={styles.authorInfo}>
          <img
            src="https://q1.itc.cn/images01/20240907/b9ec9c7d597a47ee90fbb655e2d03855.jpeg"
            alt="林毛毛"
            className={styles.avatar}
          />
          <p>林毛毛，足球爱好者，拥有100年足球执教经历，经历丰富</p>
        </div>
      </section>
...
{/* 订阅 CTA - 修改表单，添加 onSubmit 事件 */}
      ...
      <section className={styles.widget}>
        ...
        <div className={styles.partners}>
          <img src={baiduPng} alt="Partner 1" />
          <img src={pzPng} alt="Partner 2" />
        </div>
      </section>
    </aside>
  );
